    ...
    <div>
      ...
      <div className="card-grid">
        ...
        <div className="card">
          ...
          {(botStatus === 'disconnected' || botStatus === 'qr' || botStatus === 'pairing' || botStatus === 'connecting') && (
              ...
              {authMode === 'phone' ? (
                <div>
                  {pairingCode ? (
                    ...
                    <div style={{ textAlign: 'center', padding: '20px', background: 'var(--bg-input)', borderRadius: 'var(--radius-md)' }}>
                      <div style={{ color: 'var(--accent)', fontSize: '14px', fontWeight: 500, marginBottom: '12px' }}>
