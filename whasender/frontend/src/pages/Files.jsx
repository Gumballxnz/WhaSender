...
import { Upload, FileText, Trash2, CheckCircle2, Loader2, Info, AlertTriangle, HardDrive } from 'lucide-react';
                    ...
                    {vpsFiles.map(f => (
                      <tr key={f.name}>
                        ...
                        <td style={{ textAlign: 'right' }}>
                          <button onClick={() => confirmDeleteFile(f.name)} style={{ background: 'none', border: 'none', color: 'var(--danger)', cursor: 'pointer', padding: '4px' }}>
                            <Trash2 size={14} />
                          </button>
                        </td>
                      </tr>
