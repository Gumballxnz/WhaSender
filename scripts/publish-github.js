...
console.log('\n======================================================');
console.log('   Publicando no GitHub Packages (@gumballxnz/whasender)');
console.log('======================================================\n');
...
pkg.name = '@gumballxnz/whasender';
pkg.repository = 'https://github.com/Gumballxnz/WhaSender';
pkg.publishConfig = {
...
try {
  ...
  console.log(' -> https://github.com/Gumballxnz/WhaSender/packages');
